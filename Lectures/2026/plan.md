...
entre los temas. Este plan las distribuye 5, 7 y 9, porque la NP-completitud se da
desde cero y necesita cuatro conferencias propias, y suma una conferencia inicial
sobre modelos de cómputo, 21 en total.
...
### Conferencia 6. Divide y vencerás: la transformada rápida de Fourier
...
### Conferencia 7. Algoritmos golosos con argumentos de intercambio
...
### Conferencia 9. Programación dinámica sobre árboles y subconjuntos
...
### Conferencia 10. Optimizaciones de programación dinámica
...
### Conferencia 11. Flujo máximo: Dinic
...
### Conferencia 12. Flujo máximo: push-relabel
...
### Conferencia 13. P, NP y reducciones
...
### Conferencia 14. Cook-Levin: SAT y 3-SAT
...
### Conferencia 15. Reducciones desde 3-SAT a grafos

Reducción de 3-SAT a conjunto independiente con un triángulo por cláusula y aristas
entre literales contradictorios, y por la conferencia 13, clique y vertex cover como
...
### Conferencia 16. Reducciones a secuencias y números
...
### Conferencia 17. Resolver exacto un problema NP-duro
...
### Conferencia 18. Algoritmos de aproximación
...
### Conferencia 19. TSP métrico y redondeo de programas lineales

TSP general sin aproximación con razón constante si $P \ne NP$, usando la reducción
desde ciclo hamiltoniano de la conferencia 16. TSP métrico con el doble árbol, razón
...
### Conferencia 20. Esquemas de aproximación
...
máquinas, cerrando lo visto en la conferencia 18.

### Conferencia 21. Algoritmos aleatorios
...
el curso volviendo al ciclo de la conferencia 2, con la probabilidad como parte de la
garantía.
