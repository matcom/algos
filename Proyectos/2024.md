...
Es importante que el problema escogido tenga relevancia práctica. Aunque usted puede escoger un problema de cualquier área, se espera que el problema tenga una aplicación práctica en algún ámbito. Por ejemplo, un problema de optimización de rutas de reparto, planificación de horarios, optimización de redes de comunicación, etc.  No es válido inventar un problema ficticio para el cual no exista una aplicación práctica, aunque usted moldear el problema de modo que aparezcan oportunidades para aplicar las técnicas y habilidades aprendidas en el curso.
